...
export interface ApiAdultGamesPageAdultGamesPage
...
export interface ApiCoffeePageCoffeePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    classicMenuFile: Schema.Attribute.Media<
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::coffee-page.coffee-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    seasonalMenuFile: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    formType: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u041E\u0431\u0440\u0430\u0442\u043D\u0430\u044F \u0441\u0432\u044F\u0437\u044C'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::contact.contact'
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['kids', 'adults', 'openParties']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'adults'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiGameGame extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ageGroups: Schema.Attribute.JSON & Schema.Attribute.Required;
    audienceType: Schema.Attribute.Enumeration<['kids', 'adults']> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    gameType: Schema.Attribute.Enumeration<
      ['role', 'quest', 'show', 'quiz', 'tgame', 'dance']
    > &
      Schema.Attribute.Required;
    hasPremiumVersion: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::game.game'> &
      Schema.Attribute.Private;
    premiumDescription: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiKidsGamesPageKidsGamesPage extends Struct.SingleTypeSchema {
  collectionName: 'kids_games_pages';
  info: {
    description: 'Kids games page content';
    displayName: 'Kids Games Page';
    pluralName: 'kids-games-pages';
    singularName: 'kids-games-page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiOpenPartiesPageOpenPartiesPage
  extends Struct.SingleTypeSchema {
...
export interface ApiPersonalPartiesPagePersonalPartiesPage
  extends Struct.SingleTypeSchema {
  collectionName: 'personal_parties_pages';
  info: {
    description: 'Content for the Personal Parties page';
    displayName: 'Personal Parties Page';
    pluralName: 'personal-parties-pages';
    singularName: 'personal-parties-page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiThemePartyEventThemePartyEvent
  extends Struct.CollectionTypeSchema {
  collectionName: 'theme_party_events';
  info: {
    displayName: 'Theme-party-event';
    pluralName: 'theme-party-events';
    singularName: 'theme-party-event';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::theme-party-event.theme-party-event'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::adult-games-page.adult-games-page': ApiAdultGamesPageAdultGamesPage;
      'api::coffee-page.coffee-page': ApiCoffeePageCoffeePage;
